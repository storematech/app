...
object QuizDetailPdfExporter {
    ...
    private const val PAGE_WIDTH = 842 // A4 landscape at 72dpi — more room for the extra columns
    ...
    fun export(context: Context, data: QuizDetailViewData): Intent {
        val columns = listOf(
            "Name" to 160f, "Email" to 190f, "Score" to 70f,
            "Correct" to 90f, "Time" to 70f, "Completed" to 160f
        )
        ...
        val headerTextPaint = Paint().apply { color = Color.WHITE; textSize = 9.5f; isFakeBoldText = true }
